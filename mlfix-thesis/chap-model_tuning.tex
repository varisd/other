...
are in~\Fref{cat-sel}. We can see that with the HimL dataset, the feature selection did not have
...
The summary of their in-domain final performance is in`\Tref{cats-summary}. We have compared performance
