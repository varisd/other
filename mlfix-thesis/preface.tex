...
\fixme{Bechara, Simard - opravit bibtex}
...
%TODO pridat "SMT error analysis"?

\section{Thesis Structure}
%Nazvy kapitol a poradi in progress

%TODO: strucny popis depfixu? popis castych chyb?
% nechat na popis pipeline (rozdily oproti depfixu) a analyzu dat (frekvence chyb v realu)
% frekvence chyb - kombinovany barplot
