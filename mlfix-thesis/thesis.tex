...
Depfix system. The aim of the research was to investigate the possibilities of statistical inentification
of the most common morphological errors produced by the state-of-the-art machine translation systems and
train a sufficient models built on the acquired knowledge. The system was mainly developed on the English-to-Czech
...
\def\Keywords{%
{automatic post-editing,} {machine translation,} {supervised machine learning,} {natural language processing,} {Treex}
}
