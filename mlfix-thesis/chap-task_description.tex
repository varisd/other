...
Oracle-Depfix  & 800  &  75  &  3  &  47  &  25  &  62.6\%  &  5.5\%  \\
\end{tabular}
\caption{
...
by the Oracle classifier. When compared to the results achieved on the data with Depfix
reference sentences we can see that the precission remains similar, however, the recall is much
lower. We can therefore assume that the Depfix data can be useful but they are much more sparse
