...
For this reason, we have decided to examine training data, where we created \equo{syntetic} post-editation
...
We present in~\Tref{oracle-maneval} results of the manual evaluation.
